<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('daftars.*') ? 'active' : '' }}"
                    href="{{ route('daftars.index') }}">
                    <span data-feather="users" class="align-text-bottom"></span>
                    Data Siswa Prakerin
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('industris.*') ? 'active' : '' }}"
                    href="{{ route('industris.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('logbooks.*') ? 'active' : '' }}"
                    href="{{ route('logbooks.index') }}">
                    <span data-feather="clipboard" class="align-text-bottom"></span>
                    Data Laporan Prakerin
                </a>
            </li>
            @endif
        </ul>
