...
final class LaporanTable extends PowerGridComponent
{
    ...
    public function bulkCheckedDelete()
    {
        if (auth()->check()) {
            ...
            try {
                ...
                $this->dispatchBrowserEvent('showToast', ['success' => true, 'message' => 'Data laporan berhasi dihapus.']);
    ...
    public function bulkCheckedEdit()
    {
        if (auth()->check()) {
            ...
            return $this->dispatchBrowserEvent('redirect', ['url' => route('laporans.edit', ['ids' => $ids])]);
        }
    }
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Laporan>
     */
    public function datasource(): Builder
    {
        return Laporan::query()->latest();
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('tglkegiatan_formatted', fn (Laporan $model) => Carbon::parse($model->tglkegiatan)->format('d/m/Y'))
            ->addColumn('created_at')
            ->addColumn('created_at_formatted', fn (Laporan $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Rincian Kegiatan', 'rincian')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),
