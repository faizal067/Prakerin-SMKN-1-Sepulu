...
final class IndustriForm extends PowerGridComponent
{
    use ActionButton;
    ...
    public function bulkCheckedDelete()
    {
        if (auth()->check()) {
            ...
            try {
                Industri::whereIn('id', $ids)->delete();
                $this->dispatchBrowserEvent('showToast', ['success' => true, 'message' => 'Data industri berhasi dihapus.']);
    ...
    public function bulkCheckedEdit()
    {
        if (auth()->check()) {
            ...
            return $this->dispatchBrowserEvent('redirect', ['url' => route('industris.edit', ['ids' => $ids])]);
        }
    }
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Industri>
     */
    public function datasource(): Builder
    {
        return Industri::query()->latest();
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', fn (Industri $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Nama Industri', 'nama')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),

            Column::make('Lokasi Industri', 'lokasi')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),

            Column::make('Deskripsi Industri', 'deskripsi')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),

            Column::make('Kebutuhan Industri', 'kebutuhan')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),
